...
<head>
  ...
  <title>Categoria Cereales Y Granos | Huerta directa</title>
...
<body>
  ...
  $productos = $producto->ConsultaEspecifica('category', 'cereales-granos');
  ?>
...
<?php include '../modelosFront/carritoProducto.php'; ?>
  ...
  <main class="products container1" id="lista-1">
    <h2 class="productosCatePhp" data-aos="zoom-in">Cereales y Granos</h2>
