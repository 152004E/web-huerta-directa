            ...
            <ul>
              <li class="submenu">
                ...
                <div id="carrito">
                  ...
                  <a href="../views/pasarela2.html" id="miBoton" class="btn-2">Ir a pagar</a>
                  ...
                  <div class="swiper-slide">
                    <div class="item">
                      ...
                      <div class="text-content flexcol">
                        ...
                        <h2>
                          <span>Del campo a tu casa</span><br /><strong
                            >Las más frescas del mercado</strong
                          >
                        </h2>
                  ...
                  <div class="swiper-slide">
                    <div class="item">
                      ...
                      <div class="text-content flexcol">
                        <h4>Fruta Fresca</h4>
                        <h2>
                          <span>Recién Cosechada</span><br /><strong
                            >Productos de calidad</strong
                          >
                        </h2>
                  ...
                  <div class="swiper-slide">
                    <div class="item">
                      ...
                      <div class="text-content flexcol">
                        ...
                        <h2>
                          <span>La mejor cosecha</span><br /><strong
                            >Agro Colombiano
                          </strong>
                        </h2>
                        <a href="#" class="primary-button">Ver Más</a>
                  ...
                  <div class="swiper-slide">
                    <div class="item">
                      ...
                      <div class="text-content flexcol">
                        <h4>100% con amor</h4>
                        <h2>
                          <span>De la mejor calidad</span><br /><strong
                            >De la huerta, Directo a tu casa</strong
                          >
                        </h2>
                        <a href="#" class="primary-button">Ver Más</a>
                      </div>
        ...
        >
          ...
          >
            ...
            <ul style="list-style: none; padding: 0">
              <li>
                <a href="login/login/pagina.html" style="text-decoration: none"
                  >Inicio</a
                >
              </li>
              <li>
